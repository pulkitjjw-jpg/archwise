...
import GrowthTriggerToast from "./GrowthTriggerToast";
...
//
// Also the mount point for GrowthTriggerProvider: it needs to sit ABOVE WorkspaceTabs' internal
// tab-switching (which fully unmounts whichever tab isn't active), so a growth-trigger's
// analyze/review/apply state survives the user switching tabs mid-process instead of being lost
// or, in ArchitectureWorkspace's case, never even starting because its listener wasn't mounted
// when the chat side fired the trigger.
